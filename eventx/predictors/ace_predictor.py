...
@Predictor.register('ace-eventx-predictor')
class AcePredictor(Predictor):
    ...
    def _extract_trigger_and_entity_spans(ner_tags):
        ...
        trigger_spans = AcePredictor._extract_exclusive_spans(triggers_with_spans)
        entity_spans = AcePredictor._extract_exclusive_spans(entity_types_with_spans)
